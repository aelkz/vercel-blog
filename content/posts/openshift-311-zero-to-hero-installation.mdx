...
Edit your wireless interface. It will be something like `ifcfg-{SSID}`
...
```bash
curl -s -o /dev/null -w "%{http_code}" http://myapp-demo.apps.arekkusu.io
```

Check if it returns status code 200.
