---
title: "Microservices Coffeeshop"
publishedDate: "2020-03-14"
lastUpdatedDate: "2020-03-14"
tags:
  - technology
description: "APIs integration and monitoring with Eclipse MicroProfile, demonstrating microservices architecture with Thorntail applications."
status: published
---
...
![](/images/microservices-coffeeshop/78CDD2957A571A75D111D5D8BFAEC34E.png)
...
![](/images/microservices-coffeeshop/D0A39464F60F43E313DA1E8060A1C272.png)

**OBS**.: You might want to add the jboss.org repository and add to maven-group and maven-public repositories on nexus:

See: parent project pom.xml for details on `<repositories>` tag.

![](/images/microservices-coffeeshop/2B9E458A4AF1189513F4988DB9573639.png)
...
![](/images/microservices-coffeeshop/C2889DA640D07E02D4E4C134B56BA0A8.png)
...
[http://localhost:8080/metrics](http://localhost:8080/metrics) (all metrics)

[http://localhost:8080/metrics/application](http://localhost:8080/metrics/application) (exclusively for application-level metrics)
...
[https://www.redhat.com/en/blog/custom-grafana-dashboards-red-hat-openshift-container-platform-4](https://www.redhat.com/en/blog/custom-grafana-dashboards-red-hat-openshift-container-platform-4)

[https://github.com/integr8ly/application-monitoring-operator/blob/master/scripts/install.sh](https://github.com/integr8ly/application-monitoring-operator/blob/master/scripts/install.sh)

[https://medium.com/@zhimin.wen/grafana-dashboard-in-ocp4-2-44468e5390d0](https://medium.com/@zhimin.wen/grafana-dashboard-in-ocp4-2-44468e5390d0)

[https://operatorhub.io/operator/grafana-operator](https://operatorhub.io/operator/grafana-operator)
...
![](/images/microservices-coffeeshop/9284EAE7A078631050A3F2EB9CF4B351.png)
...
![](/images/microservices-coffeeshop/A8FF0B41453F76DC82EFE65348C5B117.png)

To this:

![](/images/microservices-coffeeshop/77C55CBC16AA2D83CB3D17E50E76D63B.png)
...
![](/images/microservices-coffeeshop/6B42ECA6F89BE517DACA7B44D44C2F40.png)
...
![](/images/microservices-coffeeshop/48D5C0DCCC89ECC3B7720D4472BA10B4.png)
