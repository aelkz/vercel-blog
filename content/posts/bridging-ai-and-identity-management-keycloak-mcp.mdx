...
**It provides AI assistants with a bunch of specialized tools to manage users, groups, realms, authentication flows, and client scopes—all while maintaining strict safety controls and type validation.**
...
## The Entry Point: How to start with the keycloak-mcp-entrypoint wrapper
...
- Keycloak admin credentials or service account (recommended)
...
- <a href="https://github.com/aelkz/another-keycloak-mcp" target="_blank" rel="noopener noreferrer">
    another-keycloak-mcp
  </a>
  : Core MCP server with 45 Keycloak management tools
- <a href="https://github.com/aelkz/keycloak-mcp-entrypoint" target="_blank" rel="noopener noreferrer">
    keycloak-mcp-entrypoint
  </a>
  : Streamlined entry point for AI tool integration
