...
- [another-keycloak-mcp](https://github.com/aelkz/another-keycloak-mcp): Core MCP server with 45 Keycloak management tools
- [keycloak-mcp-entrypoint](https://github.com/aelkz/keycloak-mcp-entrypoint): Streamlined entry point for AI tool integration
